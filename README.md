...
- **Gestión de contactos** con sistema de identidad upeer ID

### 🚀 **Arquitectura de Instalación Inteligente**

- **Paquetes nativos**: Debian (.deb), RPM (.rpm), Windows (.exe), macOS (.zip)
- **Servicio systemd dedicado** (`upeer-yggdrasil.service`)
...
wget https://github.com/upeer/chat-p2p/releases/latest/download/upeer-chat_1.0.0_amd64.deb

# Instalar (requiere sudo solo una vez)
sudo apt install ./upeer-chat_1.0.0_amd64.deb
...
- 📡 **Servicio de red mesh** (`upeer-yggdrasil.service`)
- 👤 **Usuario/grupo dedicado** `yggdrasil:yggdrasil`
- 🔧 **Configuración Yggdrasil** en `/etc/upeer/yggdrasil.conf`
...
# Extraer y arrastrar uPeer.app a /Applications
```

## 🚀 Primeros Pasos

1. **Inicia la aplicación** por primera vez
2. **Tu identidad se generará automáticamente** (upeer ID)
...
# Ejemplo de flujo
$ upeer-chat
🌐 Conectando a la red upeer...
✅ Red mesh activa con IPv6: 200:xxxx:xxxx:xxxx
🆔 Tu ID upeer: 802d20068fe07d3c3c16a15491210cd2
...
git clone https://github.com/upeer/chat-p2p.git
cd chat-p2p
...
5. **Identidad soberana**: upeer ID con firmas Ed25519
...
Para ver el roadmap completo y detallado, consulta [UPeer_Roadmap.md](./UPeer_Roadmap.md).

## 🤝 Contribuir

¡Las contribuciones son bienvenidas! uPeer es un proyecto de código abierto que busca democratizar las comunicaciones descentralizadas.
...
- **Estética upeer**: Usa Joy UI con bordes `xl`, sombras `lg` y paleta armónica
...
- **Sitio web**: [https://upeer.chat](https://upeer.chat)
- **Repositorio**: [https://github.com/upeer/chat-p2p](https://github.com/upeer/chat-p2p)
- **Roadmap detallado**: [UPeer_Roadmap.md](./UPeer_Roadmap.md)
- **Reportar problemas**: [Issues](https://github.com/upeer/chat-p2p/issues)
...
_"La verdadera privacidad no es tener algo que ocultar, sino tener algo que proteger"_
