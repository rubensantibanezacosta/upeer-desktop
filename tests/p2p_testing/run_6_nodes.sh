...
# Node 1
docker run -d --name p2p_node_1 --cap-add=NET_ADMIN --device=/dev/net/tun -v /tmp/p2p_shared:/shared -e NODE_ENV_NAME=node1 upeer-bot
...
# Node 2
docker run -d --name p2p_node_2 --cap-add=NET_ADMIN --device=/dev/net/tun -v /tmp/p2p_shared:/shared -e NODE_ENV_NAME=node2 -e TARGET_IDENTITY=$TARGET1 upeer-bot
...
# Node 3
docker run -d --name p2p_node_3 --cap-add=NET_ADMIN --device=/dev/net/tun -v /tmp/p2p_shared:/shared -e NODE_ENV_NAME=node3 -e TARGET_IDENTITY=$TARGET2 upeer-bot
...
# Node 4
docker run -d --name p2p_node_4 --cap-add=NET_ADMIN --device=/dev/net/tun -v /tmp/p2p_shared:/shared -e NODE_ENV_NAME=node4 -e TARGET_IDENTITY=$TARGET3 upeer-bot
...
# Node 5
docker run -d --name p2p_node_5 --cap-add=NET_ADMIN --device=/dev/net/tun -v /tmp/p2p_shared:/shared -e NODE_ENV_NAME=node5 -e TARGET_IDENTITY=$TARGET4 upeer-bot
...
# Node 6
docker run -d --name p2p_node_6 --cap-add=NET_ADMIN --device=/dev/net/tun -v /tmp/p2p_shared:/shared -e NODE_ENV_NAME=node6 -e TARGET_IDENTITY=$TARGET5 upeer-bot
