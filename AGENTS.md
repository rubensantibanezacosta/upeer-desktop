...
9. **PNPM**:
    - Usa `pnpm` para la gestión de dependencias y scripts. Evita usar `npm` o `yarn` para estas tareas, ya que pueden causar inconsistencias en el entorno de desarrollo.