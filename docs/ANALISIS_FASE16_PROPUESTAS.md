...
RevelNest Chat P2P ha completado la **Fase 15** con las siguientes capacidades validadas:
...
- Sistema aplica límites por `revelnestId` (identidad criptográfica) además de IP.
