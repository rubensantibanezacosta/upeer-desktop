# RESUMEN: Pruebas de Escalabilidad upeer
...
**La infraestructura P2P de upeer ha demostrado ser escalable y robusta:**
...
**upeer está listo para la siguiente fase: implementación de transferencia de archivos y funcionalidades sociales avanzadas sobre esta base sólida de red P2P.**
