---
title: Patrones de diseño Joy UI para upeer
...
# Patrones de diseño Joy UI para upeer
  ...
  return (
    <Modal open={open} onClose={onClose}>
      ...
      >
        ...
        <Divider />
        <DialogContent sx={{ p: 3 }}>{/* Contenido aquí */}</DialogContent>
      </ModalDialog>
    </Modal>
  );
};
...
## Convenciones específicas de upeer
