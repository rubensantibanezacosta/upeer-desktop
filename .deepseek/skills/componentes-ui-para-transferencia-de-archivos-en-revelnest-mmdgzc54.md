---
title: Componentes UI para Transferencia de Archivos en upeer
...
# Componentes UI para Transferencia de Archivos en upeer

**Source:** Análisis de componentes existentes y requisitos de Fase 16

---

# Componentes UI para Transferencia de Archivos en upeer (Fase 16)
...
3. **Inicia transferencia** → window.upeer.startFileTransfer()
...
7. **Usuario abre/descarga** → window.upeer.saveTransferredFile()
