---
title: Guía de pruebas manuales para transferencia de archivos upeer
...
# Guía de pruebas manuales para transferencia de archivos upeer

**Source:** Implementación Fase 16 - Transferencia de archivos

---

# Guía de pruebas manuales para transferencia de archivos upeer (Fase 16)
...
**Workaround:** Eliminar la base de datos local (~/.config/upeer-chat) para regenerar esquema.
